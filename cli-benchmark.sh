...
#    MYSQL_LOG_URL_LINE=$(grep "MYSQL_LOG_URL" $BENCHMARK_HOME/conf/config.properties)
#    MYSQL_LOG_URL_VALUE=${MYSQL_LOG_URL_LINE#*=}
#    IS_USE_MYSQL_LINE=$(grep "IS_USE_MYSQL" $BENCHMARK_HOME/conf/config.properties)
#    IS_USE_MYSQL_VALUE=${IS_USE_MYSQL_LINE#*=}
#    sed -i "s/^MYSQL_LOG_URL.*$/MYSQL_LOG_URL=${MYSQL_LOG_URL_VALUE}/g" $CLIENT_LOG_STOP_FLAG_PATH/iotdb-benchmark/conf/clientSystemInfo.properties
#    sed -i "s/^IS_USE_MYSQL.*$/MYSQL_LOG_URL=${IS_USE_MYSQL_VALUE}/g" $CLIENT_LOG_STOP_FLAG_PATH/iotdb-benchmark/conf/clientSystemInfo.properties
#
